...
namespace Gestion.View
{
    public partial class frmProprietaire : Form
    {
        ...
        private void btnChoisirP_Click(object sender, EventArgs e)
        {
            txtPrenom.Text = dgProprietaire.CurrentRow.Cells[1].Value.ToString();
            txtNom.Text = dgProprietaire.CurrentRow.Cells[2].Value.ToString();
            ...
            txtCNI.Text = dgProprietaire.CurrentRow.Cells[5].Value.ToString();
            txtNinea.Text = dgProprietaire.CurrentRow.Cells[6].Value.ToString();
            txtRCCM.Text = dgProprietaire.CurrentRow.Cells[7].Value.ToString();
        }
